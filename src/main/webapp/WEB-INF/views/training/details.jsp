...
<body>
	...
	<br/>
	<h4>Lista wszystkich szkoleń:</h4><br/>
	${message}
					...
					<c:forEach items="${trainings}" var="training">
						<tr>
							...
							<td>
								...
								<a href='<c:url value = '/training/registration/${training.id}'/>'>zapisy</a> /
								<a href='<c:url value = '/training/participants/${training.id}'/>'>lista uczestników</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
